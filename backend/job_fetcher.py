        ...
        items.append(
            {
                ...
                "company_website_url": row.get("company", {}).get("url"),
                "company_logo_url": row.get("company", {}).get("logo"),
        ...
        items.append(
            {
                ...
                "company_website_url": row.get("employer_website") or row.get("job_publisher"),
                "company_logo_url": row.get("employer_logo"),
                "description": description[:4000],
                "skills_csv": ",".join(_extract_keywords_from_cv(description)[:20]),
        ...
        items.append(
            {
                ...
                "company_website_url": row.get("website"),
                "company_logo_url": row.get("logo"),
        ...
        items.append(
            {
                ...
                "apply_url": row.get("url"),
                "company_website_url": row.get("company_website"),
        ...
        items.append(
            {
                ...
                "company_website_url": row.get("company_url"),
                "company_logo_url": row.get("company_logo"),
                "description": description,
                "skills_csv": ",".join(_extract_keywords_from_cv(description)[:20]),
        ...
        items.append(
            {
                ...
                "job_type": None,
                "apply_url": landing,
                "company_website_url": ((row.get("company") or {}).get("refs") or {}).get("landing_page"),
                "company_logo_url": ((row.get("company") or {}).get("refs") or {}).get("logo_image"),
